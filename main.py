...
with st.sidebar.form("parameter_form"):
    ...
    st.header("Model for temperature effect on biomass growth")
    st.text("Cardinal Temperature Model with Inflection (CTMI)")
    st.text("Developped by Rosso et al., 1993, https://doi.org/10.1006/jtbi.1993.1099")
    st.link_button("https://doi.org/10.1006/jtbi.1993.1099",  https://doi.org/10.1006/jtbi.1993.1099)
    st.text("First applied to microalgae by Bernard and Rémond, 2012, https://doi.org/10.1016/j.biortech.2012.07.022")
